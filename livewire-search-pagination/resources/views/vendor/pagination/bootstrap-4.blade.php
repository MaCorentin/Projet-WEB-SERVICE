    ...
    <nav>
        <ul class="pagination">
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item" style="color:#E05252">
                    <a class="page-link" href="#" wire:click="setPage('{{ $paginator->nextPageUrl() }}')" rel="next" aria-label="@lang('pagination.next')" >&rsaquo;</a>
                </li>
            @else
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.next')" style="color:#E05252">
                    <span class="page-link" aria-hidden="true" style="color:#E05252" >&rsaquo;</span>
                </li>
            @endif
        </ul>
    </nav>
